...
module.exports = {
    getImage: function (msg,params){
        // Check if its one of the poo stains
        if (params=="Kieran October"||params=="kieran october"){
        ...
        else if (params=="Matthew Hodges" || params=="matthew hodges"){
            msg.channel.send("https://pbs.twimg.com/profile_images/1268079021734019073/G2Iht4Wp_400x400.jpg")
        }
        else if (params=="Ethan Hodges" || params=="ethan hodges"){
